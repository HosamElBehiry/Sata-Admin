              ...
              <>
                {image.slice(0, 5).map((_img, i) => (
                  <Fragment key={i}>
                      ...
                      <div
                        ...
                        style={
                          productImages[i] === ""
                            ...
                            : !isChanged[i]
                            ? {
                                backgroundImage: `url(${process.env.REACT_APP_API_URL}/${productImages[i]})`,
                              }
                            : {
                    ...
                    <ErrorMessage name={`image[${i}]`} component={TextError} />
                  </Fragment>
                ))}
              </>
            );
