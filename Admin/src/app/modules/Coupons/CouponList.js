...
import { getAllCoupons, DeleteCouponById } from "../../actions/coupons/coupons";
      ...
      <table className="table table-hover align-middle gs-0 gy-4">
        <thead>
          <tr className="text-center border-3 fw-bolder text-muted bg-light">
            ...
            <th className="ps-4 min-w-100px">
              <FormattedMessage id="BLOG.ACITONS" />
            </th>
          </tr>
        </thead>
        <tbody>
            ...
            currentCoupons.map((coupon) => (
              <tr className="text-center border-3 m-auto" key={coupon._id}>
                <td className="border text-center">
                  <div className="d-flex flex-column">{coupon.code}</div>
                </td>
                <td className="border text-center">
                  <div className="d-flex flex-column">{coupon.amount}</div>
                </td>
                <td className="border text-center">
                ...
                <td className="border text-center">
                  <span>
                    ...
                    <i
                      ...
                      onClick={() => DeleteCouponById(coupon._id)}
                    />
                  </span>
                  <span></span>
                </td>
...
export default connect(mapStateToProps, { getAllCoupons, DeleteCouponById })(
  CouponList
);
